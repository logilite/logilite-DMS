...
public class DefaultMountingStrategy implements IMountingStrategy
{
	...
	public MDMSContent getMountingParent(int AD_Table_ID, int Record_ID, String trxName)
	{
		...
		if (DMS_Content_ID > 0)
		{
			MDMSContent content = new MDMSContent(Env.getCtx(), DMS_Content_ID, trxName);
			return content;
		}
		return null;
	} // getMountingParent
	...
	public MDMSContent getMountingParentForArchive(int AD_Table_ID, int Record_ID, int Process_ID)
	{
		...
		if (Process_ID > 0)
		{
			...
			if (processContentID <= 0)
			{
				...
				MDMSVersion.create(processContentID, pValue, 0, null, null);
			}
		...
		else
		{
			...
			if (recordContentID <= 0)
			{
				...
				MDMSVersion.create(recordContentID, String.valueOf(Record_ID), 0, null, null);
			}
