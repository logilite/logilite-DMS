...
@org.adempiere.base.Model(table="DMS_Association")
public class X_DMS_Association extends PO implements I_DMS_Association, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_DMS_Association (Properties ctx, int DMS_Association_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, DMS_Association_ID, trxName, virtualColumns);
      /** if (DMS_Association_ID == 0)
        {
			setDMS_Association_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_DMS_Association (Properties ctx, String DMS_Association_UU, String trxName)
    {
      super (ctx, DMS_Association_UU, trxName);
      /** if (DMS_Association_UU == null)
        {
			setDMS_Association_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_DMS_Association (Properties ctx, String DMS_Association_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, DMS_Association_UU, trxName, virtualColumns);
      /** if (DMS_Association_UU == null)
        {
			setDMS_Association_ID (0);
        } */
    ...
    {
      StringBuilder sb = new StringBuilder ("X_DMS_Association[")
	...
	*/
	...
	{
		return (com.logilite.dms.model.I_DMS_AssociationType)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_AssociationType.Table_ID)
	...
	*/
	...
	public com.logilite.dms.model.I_DMS_Content getDMS_Content_Related() throws RuntimeException
	{
		return (com.logilite.dms.model.I_DMS_Content)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_Content.Table_ID)
