...
public class X_DMS_Content extends PO implements I_DMS_Content, I_Persistent 
{
    ...
    {
		return (com.logilite.dms.model.I_DMS_ContentType)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_ContentType.Table_Name)
    ...
    {
		return (com.logilite.dms.model.I_DMS_MimeType)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_MimeType.Table_Name)
    ...
    {
		return (com.logilite.dms.model.I_DMS_Status)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_Status.Table_Name)
