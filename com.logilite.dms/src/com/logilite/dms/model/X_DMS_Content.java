...
@org.adempiere.base.Model(table="DMS_Content")
public class X_DMS_Content extends PO implements I_DMS_Content, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_DMS_Content (Properties ctx, int DMS_Content_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, DMS_Content_ID, trxName, virtualColumns);
      /** if (DMS_Content_ID == 0)
        {
			setDMS_Content_ID (0);
			setDMS_MimeType_ID (0);
    ...
    /** Standard Constructor */
    public X_DMS_Content (Properties ctx, String DMS_Content_UU, String trxName)
    {
      super (ctx, DMS_Content_UU, trxName);
      /** if (DMS_Content_UU == null)
        {
			setDMS_Content_ID (0);
			setDMS_MimeType_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_DMS_Content (Properties ctx, String DMS_Content_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, DMS_Content_UU, trxName, virtualColumns);
      /** if (DMS_Content_UU == null)
        {
			setDMS_Content_ID (0);
			setDMS_MimeType_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_DMS_Content[")
	...
	*/
	...
	{
		return (com.logilite.dms.model.I_DMS_MimeType)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_MimeType.Table_ID)
	...
	*/
	...
	{
		return (com.logilite.dms.model.I_DMS_Status)MTable.get(getCtx(), com.logilite.dms.model.I_DMS_Status.Table_ID)
	...
	*/
	...
	/** Set Valid From.
		@param ValidFromDate DMS Conent validity From Date
	*/
	...
	/** Set Valid To.
		@param ValidToDate DMS Conent validity To Date
	*/
