...
public interface I_DMS_Permission 
{
    ...
    /** Column name DMS_Permission_UU */
    public static final String COLUMNNAME_DMS_Permission_UU = "DMS_Permission_UU";
    ...
    /** Column name IsAllPermission */
    public static final String COLUMNNAME_IsAllPermission = "IsAllPermission";
    ...
    public static final String COLUMNNAME_IsDelete = "IsDelete";
    ...
    public static final String COLUMNNAME_IsNavigation = "IsNavigation";
    ...
    /** Column name IsWrite */
    public static final String COLUMNNAME_IsWrite = "IsWrite";
