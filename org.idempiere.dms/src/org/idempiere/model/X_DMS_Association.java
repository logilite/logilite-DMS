...
public class X_DMS_Association extends PO implements I_DMS_Association, I_Persistent
{
	...
	public X_DMS_Association(Properties ctx, int DMS_Association_ID, String trxName)
	{
		...
		/**
		 * if (DMS_Association_ID == 0) { setDMS_Association_ID (0); }
		 */
	}
	...
	{
		StringBuffer sb = new StringBuffer("X_DMS_Association[").append(get_ID()).append("]");
		return sb.toString();
	}

	public org.compiere.model.I_AD_Table getAD_Table() throws RuntimeException
	{
		return (org.compiere.model.I_AD_Table) MTable.get(getCtx(), org.compiere.model.I_AD_Table.Table_Name).getPO(
				getAD_Table_ID(), get_TrxName());
	}
	...
	{
		return (org.idempiere.model.I_DMS_AssociationType) MTable.get(getCtx(),
				org.idempiere.model.I_DMS_AssociationType.Table_Name).getPO(getDMS_AssociationType_ID(), get_TrxName());
	}
